    ...
    <div class="col-full">
        ...
        <div class="site-address">
            <ul class="address">
                ...
                <li>Telephone: +380967121924</li>
                <li>Fax: +1 222 333 444</li>
            </ul>
        </div>
        <div class="site-info">
            <p class="copyright">Copyright &copy; 2018 <br> All rights reserved.</p>
        </div>
        <!-- .site-info -->
        <a role="button" class="footer-action-btn" data-toggle="collapse" href="{{route('locator')}}"><i class="po po-map-marker"></i>Find us on Map</a>
    </div>
    <!-- .col-full -->
</footer>
<!-- #colophon -->
